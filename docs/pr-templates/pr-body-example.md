...
- Added architectural guidelines document with the project architectural outline and our team's git/development workflow guidance.
- Added bare-bones solution content with the folder structure and all projects as defined in the architectural guidelines document.
- Updated all READMEs to ensure they have links and information relevant to the current state of the repo.