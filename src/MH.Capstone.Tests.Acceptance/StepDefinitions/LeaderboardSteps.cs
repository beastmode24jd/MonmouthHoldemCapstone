...
public class LeaderboardSteps
{
    ...
    {
        var connectionString = Environment.GetEnvironmentVariable("ACCEPTANCE_TEST_CONNSTR")
                               ?? throw new InvalidOperationException(
                                   "Set the ACCEPTANCE_TEST_CONNSTR environment variable with the database connection string.");
