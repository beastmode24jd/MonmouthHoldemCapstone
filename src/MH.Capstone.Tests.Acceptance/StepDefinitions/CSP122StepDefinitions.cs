...
namespace MH.Capstone.Tests.Acceptance.StepDefinitions
{
    ...
    public class CSP122StepDefinitions
    {
        ...
        public void WhenAlexSubmitsASightingWithAnImage(string imageQuality)
        {
            ...
            _sightingsDriver.SetTimestamp(DateTimeOffset.UtcNow.AddHours(-1));
            _sightingsDriver.SetDescription($"CSP-122 test sighting ({imageQuality})");
        ...
        private Sighting GetMostRecentSightingForAlex()
        {
            ...
            // Test scenarios always submit with Timestamp = UtcNow.AddHours(-1), so the most
            // recently submitted sighting has the latest Timestamp value among Alex's rows.
