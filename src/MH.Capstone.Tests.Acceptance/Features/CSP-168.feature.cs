...
namespace MH.Capstone.Tests.Acceptance.Features
{
    ...
    public partial class CSP_168SetDisplayNameFromAccountSettingsFeature
    {
        ...
        private static global::Reqnroll.FeatureInfo featureInfo = new global::Reqnroll.FeatureInfo(new global::System.Globalization.CultureInfo("en"), "Features", "CSP-168 — Set Display Name from Account Settings", "  As a User, when I register a new account or log in for the first time after a s" +
                "ite update,\r\n  I want to set a display name so that my chosen name appears acros" +
                "s the site instead of my email address.", global::Reqnroll.ProgrammingLanguage.CSharp, featureTags, InitializeCucumberMessages());
